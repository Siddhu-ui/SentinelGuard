...
from models import Scan, Threat, User
from schemas import LoginIn, RegisterIn, ScanOut, TokenOut, UserOut
...
Base.metadata.create_all(bind=engine); settings.upload_path.mkdir(parents=True, exist_ok=True)
